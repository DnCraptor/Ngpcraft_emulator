// platform/vga_detect.cpp — VGA-vs-HDMI cable auto-detect, vendored verbatim from
// pico-speccy (src/pwm_audio.cpp): probes the two VGA base pins with passive
// pull-up/down (and active drive in the ambiguous cases) to recognise the VGA
// resistor ladder. main() feeds the result into linkVGA01; with video_driver=0
// the vga/hdmi driver then routes scanout to whichever cable is attached.
